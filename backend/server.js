...
//   "mongodb+srv://rajasri:rajasri@cluster0.irmyw.mongodb.net/users?retryWrites=true&w=majority&appName=Cluster0";
// mongoose
//   .connect(MONGO_URI, { useNewUrlParser: true, useUnifiedTopology: true })
//   .then(() => console.log("MongoDB connected"))
//   .catch((err) => console.error(err));
...
//   const HUGGING_FACE_API_KEY = process.env.HUGGING_FACE_API_KEY || "default_placeholder_key";
//   const IMAGE_CAPTION_MODEL_URL =
//     process.env.IMAGE_CAPTION_MODEL_URL ||
//     "https://api-inference.huggingface.co/models/Salesforce/blip-image-captioning-large";
//   const PLANT_DISEASE_MODEL_URL =
...
//       return res.status(400).send({ message: "Please upload an appropriate leaf image" });
//     }

//     // Step 2: Compress and Prepare for Plant Disease Detection
//     const compressedBuffer = await sharp(buffer).resize(224, 224).jpeg({ quality: 80 }).toBuffer();
...
//     // Send to Plant Disease Detection Model
//     const huggingFaceResponse = await axios.post(
//       PLANT_DISEASE_MODEL_URL,
//       compressedBuffer, // Send compressed image buffer
//       {
//         headers: {
//           Authorization: `Bearer ${HUGGING_FACE_API_KEY}`,
//           "Content-Type": "application/octet-stream",
...
//       return res.status(500).send({ message: "No disease detected" });
//     }

//     console.log("Highest Confidence Disease:", highestConfidenceDisease);
